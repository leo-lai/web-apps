...
Object.keys(pages).forEach(function (pathname){
  if(pathname !== 'default'){
    app.get(new RegExp('\\/' + pathname + '(?:\\/.*)?$'), function(req, res) {
...
// appRouter.get(['/admin', '/admin/*'], function(req, res) {
//   res.set('Content-Type', 'text/html')
//   res.send(compiler.outputFileSystem.readFileSync(compiler.outputPath + '/admin/index.html'))
// })
