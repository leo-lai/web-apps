<template>
	<div>
		<el-row>
			<el-col :span="2">
				<el-button type="primary">新增入库单</el-button>
			</el-col>
  		<el-col :span="22" class="l-text-right">
  			<el-form inline ref="listFilter" :model="list.filter" :rules="list.rules" @submit.native.prevent @keyup.enter.native="search">
  				<el-form-item style="width: 120px;">
  					<el-select filterable v-model="list.filter.orgId" placeholder="公司/门店" @change="search()">
				      <el-option v-for="item in zuzhiList" :key="item.orgId" :label="item.shortName" :value="item.orgId"></el-option>
				    </el-select>
  				</el-form-item>
				  <el-form-item style="width: 200px;">
				  	<el-date-picker style="width: 100%;" type="datetime" placeholder="入库时间" v-model="list.filter.dateRange" :picker-options="dateOptions"></el-date-picker>
				  </el-form-item>
				  <el-form-item style="width: 120px;">
  					<el-select filterable v-model="list.filter.orgId" placeholder="供应商" @change="search()">
				      <el-option v-for="item in zuzhiList" :key="item.orgId" :label="item.shortName" :value="item.orgId"></el-option>
				    </el-select>
  				</el-form-item>
  				<el-form-item style="width: 120px;">
  					<el-select filterable v-model="list.filter.orgId" placeholder="入库类型" @change="search()">
				      <el-option v-for="item in zuzhiList" :key="item.orgId" :label="item.shortName" :value="item.orgId"></el-option>
				    </el-select>
  				</el-form-item>
  				<el-form-item style="width: 120px;">
  					<el-input placeholder="采购单号"></el-input>
  				</el-form-item>
				  <el-form-item>
  	...
  	<el-table class="l-table-hdbg" stripe element-loading-spinner="el-icon-loading" element-loading-text="拼命加载中" 
	    ...
	    <el-table-column label="入库单号" prop="storageCode" width="200"></el-table-column>
	    <el-table-column label="入库时间" prop="createDate" width="110"></el-table-column>
	    <el-table-column label="车辆来源" prop="storageSource"></el-table-column>
