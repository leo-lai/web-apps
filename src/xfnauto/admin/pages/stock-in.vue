<template>
	<div>
  	...
  	<el-table class="l-table-hdbg" stripe element-loading-spinner="el-icon-loading" element-loading-text="拼命加载中" 
	    ...
	    <el-table-column label="供应商" prop="supplierName" min-width="120" align="center"></el-table-column>
  ...
  computed: {
	...
	methods: {
		...
		getList(page = 1, rows) {
			...
			this.$$api.stock.getInList(this.list.filter, page, rows || this.list.rows)
			.then(({data}) => {
